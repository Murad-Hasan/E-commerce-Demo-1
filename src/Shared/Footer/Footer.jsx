          ...
          <div className={`self-center md:self-end footerSocialIcon`}>
            <div className="icons flex gap-x-2">
              <svg
                ...
                viewBox="0 0 64 64"
                className="text-gray-600 h-7 w-7 fill-current cursor-pointer"
                role="img"
              >
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 64 64"
                className="text-gray-600 h-7 w-7 fill-current cursor-pointer hover:text-blue-600"
                role="img"
              >
              ...
              <svg
                ...
                viewBox="0 0 64 64"
                style={{ color:'#06B6D4'}}
                className="h-7 w-7 fill-current cursor-pointer"
                role="img"
              >
